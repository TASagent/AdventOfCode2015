...
Console.WriteLine("Day 20 - Infinite Elves and Infinite Houses");
...
static int SumUniqueFactors(int number, IEnumerable<int> primes)
{
...
static int SumUniqueFactors2(int number, IEnumerable<int> primes)
{
    IEnumerable<int> factors = Factorize(number, primes).ToArray();
...
static IEnumerable<int> GenerateFactors(IEnumerable<int> factors)
{
    yield return 1;
...
static IEnumerable<int> Factorize(int number, IEnumerable<int> primes)
{
    if (number < 1)
    {
        yield break;
